...
class ApiUtils {
  //!Base URL
  // final String _baseUrl = "http://now4kswkgo4owoks884o0wc0.103.109.210.102.sslip.io"; //! staging {error}
  final String _baseUrl =
      "http://ssc80wssow48gsgwwg8888s4.103.109.210.102.sslip.io"; //! production
