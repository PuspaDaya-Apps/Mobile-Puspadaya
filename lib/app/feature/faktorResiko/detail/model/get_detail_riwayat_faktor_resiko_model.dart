...
@JsonSerializable()
class GetDetailRiwayatFaktorResiko {
  ...
  factory GetDetailRiwayatFaktorResiko.fromJson(Map<String, dynamic> json) =>
      _$GetDetailRiwayatFaktorResikoFromJson(json);

  Map<String, dynamic> toJson() => _$GetDetailRiwayatFaktorResikoToJson(this);
}
