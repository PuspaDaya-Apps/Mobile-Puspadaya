...
import 'detail_kunjungan_berjalan_anak_tidak_hadir.dart';
                    ...
                    return DaftarKunjunganDetailItem(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return DetailKunjunganBerjalanAnakTidakHadir();
                            },
                          ),
                        );
                      },
