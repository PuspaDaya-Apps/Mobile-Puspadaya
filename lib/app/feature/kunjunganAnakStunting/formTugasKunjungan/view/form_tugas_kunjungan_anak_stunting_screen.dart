      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            BlocConsumer<SimpanKunjunganAnakStuntingBloc, SimpanKunjunganAnakStuntingState>(
              listener: (context, state) {
                debugPrint(state.toString());
                ...
                if(state is LatlangNullState) {
                  showDialog(
                    ...
                    if (value = true) {
                       BlocProvider.of<SimpanKunjunganAnakStuntingBloc>(context).add(
                        SimpanKunjungan(
                          idKunjungan: widget.idKunjungan, 
                ...
                return ButtonPrimary(
                  ...
                  mainButton: () {
                    if(widget.titikAlamat == null){
                      BlocProvider.of<SimpanKunjunganAnakStuntingBloc>(context).add(LatlangNullEvent());
                    } else {
