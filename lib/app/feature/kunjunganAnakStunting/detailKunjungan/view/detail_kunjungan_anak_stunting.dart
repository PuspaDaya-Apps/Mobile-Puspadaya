...
import '../bloc/deleteKunjunganAnakStuntingBloc/delete_kunjungan_anak_stunting_bloc.dart';
import '../bloc/detailKunjunganAnakStuntingBloc/detail_kunjungan_anak_stunting_bloc.dart';

class DetailKunjunganAnakStunting extends StatelessWidget {
  const DetailKunjunganAnakStunting({super.key, required this.idKunjungan});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => DetailKunjunganAnakStuntingBloc(),
        ),
        BlocProvider(
          create: (context) => DeleteKunjunganAnakStuntingBloc(),
        ),
      ],
      child: DetailKunjunganAnakStuntingScreen(
...
class DetailKunjunganAnakStuntingScreen extends StatefulWidget {
  const DetailKunjunganAnakStuntingScreen(
      {super.key, required this.idKunjungan});
  final String idKunjungan;

  @override
  State<DetailKunjunganAnakStuntingScreen> createState() =>
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: BlocConsumer<DetailKunjunganAnakStuntingBloc,
              DetailKunjunganAnakStuntingState>(
            ...
            builder: (context, state) {
              ...
              if (state is DetailKunjunganAnakStuntingSuccessState) {
                return Container(
                  margin:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InfoFieldWidget(
                          text: state.listDataAnakStunting.anak!.nik),
                      ...
                      InfoFieldWidget(
                          text: state.listDataAnakStunting.anak!.namaAnak),
                      SizedBox(height: SizeConfig.calHeightMultiplier(16)),
                      Row(
                              ...
                              children: [
                                ...
                                InfoFieldWidget(
                                    text: DateFormat("HH:mm", "ID_id").format(
                                        state.listDataAnakStunting.mulaiPada)),
                              ],
                            ),
                          ),
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                InfoFieldWidget(
                                    text: DateFormat("HH:mm", "ID_id").format(
                                        state
                                            .listDataAnakStunting.selesaiPada)),
                              ],
                            ),
                          ),
                        ],
                      ...
                      InfoFieldWidget(
                          text: formattedTime(state
                              .listDataAnakStunting.selesaiPada
                              .difference(state.listDataAnakStunting.mulaiPada)
                              .inSeconds)),
                      SizedBox(height: SizeConfig.calHeightMultiplier(16)),
                      const Text(
                        'Jarak Tempuh',
                      ...
                      InfoFieldWidget(
                          text: "${state.listDataAnakStunting.jarakTotal} m"),
                      SizedBox(height: SizeConfig.calHeightMultiplier(16)),
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: InfoFieldWidget(
                                    text: state.listDataAnakStunting.anak!
                      ...
                      //Maps 
                      state.listDataAnakStunting.lokasiStart == null && state.listDataAnakStunting.lokasiSelesai  == null
                      ? SizedBox.shrink()
                      : Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              onPressed: () {
                                Navigator.pushNamed(
                                  ...
                                  arguments: MapsKunjunganDataModel(
                                    titikMulai: state.listDataAnakStunting.lokasiStart != null
                                    ? LatLng(
                                      state.listDataAnakStunting.lokasiStart!.latitude, 
                                      state.listDataAnakStunting.lokasiStart!.longitude
                                    )
                                    : null,
                                    titikSelesai: state.listDataAnakStunting.lokasiSelesai != null
                                    ? LatLng(
                                      state.listDataAnakStunting.lokasiSelesai!.latitude, 
                                      state.listDataAnakStunting.lokasiSelesai!.longitude
                                    )
                                    : null
                                  )
                                );
                      ...
                      ExpansionTile(
                        ...
                        children: state.listDataAnakStunting.kunjunganTugasKader
                            .map(
                              (task) => Align(
                                alignment: Alignment.centerLeft,
                                child: Padding(
