            ...
            children: [
              ...
              BlocConsumer<TugasKunjunganIbuHamilBloc,
                ...
                builder: (context, state) {
                  if (state is TugasKunjunganIbuHamilProccessState || loadingMaps) {
                    return SizedBox(
                      width: MediaQuery.sizeOf(context).width,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            BlocConsumer<SimpanKunjunganIbuHamilBloc, SimpanKunjunganIbuHamilState>(
              listener: (context, state) {
                debugPrint(state.toString());
                ...
                return ButtonPrimary(
                  ...
                  mainButton: () {
                    if(widget.titikAlamat == null){
                      BlocProvider.of<SimpanKunjunganIbuHamilBloc>(context).add(LatlangNullEvent());
                    } else {
                      BlocProvider.of<SimpanKunjunganIbuHamilBloc>(context).add(
                        SimpanKunjungan(
                          idKunjungan: widget.idKunjungan,
