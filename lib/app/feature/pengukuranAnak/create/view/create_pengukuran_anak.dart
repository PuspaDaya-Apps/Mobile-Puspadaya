...
class _CreatePengukuranAnakViewState extends State<CreatePengukuranAnakView> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<AlatUkurAnakBloc>(context).add(
      GetAlatUkur()
    );
  }
                                    ...
                                    Navigator.push(
                                      ...
                                      setState(() {
                                        ...
                                        nameController = TextEditingController(
                                            text: paket.namaAnak);
                                        nikController =
                                            TextEditingController(text: paket.nik);
                                        ageController =
                                            TextEditingController(text: paket.usia);
                                        }
                                      });
                                    });
                                  },
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: SizeConfig.calHeightMultiplier(16)),
                            BlocListener<CreatePengukuranAnakBloc, CreatePengukuranAnakState>(
                              listener: (context, state) {
                                debugPrint(state.toString());
