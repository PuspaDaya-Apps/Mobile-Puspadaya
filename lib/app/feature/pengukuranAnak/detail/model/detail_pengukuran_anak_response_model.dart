...
// part 'detail_pengukuran_anak_response_model.g.dart';

// @JsonSerializable()
class DetailPengukuranAnakResponseModel {
  String messsage;
  String? error;
  Data? data;
  ...
  factory DetailPengukuranAnakResponseModel.fromJson(Map<String, dynamic> json) => _$DetailPengukuranAnakResponseModelFromJson(json);

  Map<String, dynamic> toJson()=>_$DetailPengukuranAnakResponseModelToJson(this);
}
...
DetailPengukuranAnakResponseModel _$DetailPengukuranAnakResponseModelFromJson(
...
Map<String, dynamic> _$DetailPengukuranAnakResponseModelToJson(
        DetailPengukuranAnakResponseModel instance) =>
    <String, dynamic>{
