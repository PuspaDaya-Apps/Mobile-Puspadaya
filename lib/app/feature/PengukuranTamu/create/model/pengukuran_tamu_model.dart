...
// part 'pengukuran_tamu_model.g.dart';

//@JsonSerializable()
class PengukuranTamuModel {
  ...
  PengukuranTamuModel({
    this.isGuest = "Iya",
    this.tempatPengukuran = "Posyandu",
  ...
  factory PengukuranTamuModel.fromJson(Map<String, dynamic> json) => _$PengukuranTamuModelFromJson(json);

  Map<String, dynamic> toJson()=>_$PengukuranTamuModelToJson(this);
}

PengukuranTamuModel _$PengukuranTamuModelFromJson(Map<String, dynamic> json) =>
    PengukuranTamuModel(
      isGuest: json['is_guest'] as String? ?? "Iya",
      tempatPengukuran: json['tempat_pengukuran'] as String? ?? "Posyandu",
...
Map<String, dynamic> _$PengukuranTamuModelToJson(
        PengukuranTamuModel instance) =>
    <String, dynamic>{
