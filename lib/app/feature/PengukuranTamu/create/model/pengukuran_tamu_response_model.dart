...
// part 'pengukuran_tamu_response_model.g.dart';

// @JsonSerializable()
class PengukuranTamuResponseModel {
  String message;
  String? error;
  Data? data;
  ...
  factory PengukuranTamuResponseModel.fromJson(Map<String, dynamic> json) => _$PengukuranTamuResponseModelFromJson(json);

  Map<String, dynamic> toJson()=>_$PengukuranTamuResponseModelToJson(this);
}
...
PengukuranTamuResponseModel _$PengukuranTamuResponseModelFromJson(
...
Map<String, dynamic> _$PengukuranTamuResponseModelToJson(
        PengukuranTamuResponseModel instance) =>
    <String, dynamic>{
