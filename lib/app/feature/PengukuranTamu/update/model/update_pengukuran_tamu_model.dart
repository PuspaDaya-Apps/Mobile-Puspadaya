...
// part 'update_pengukuran_tamu_model.g.dart';

// @JsonSerializable()
class UpdatePengukuranTamuModel {
  ...
  factory UpdatePengukuranTamuModel.fromJson(Map<String, dynamic> json) => _$UpdatePengukuranTamuModelFromJson(json);

  Map<String, dynamic> toJson()=>_$UpdatePengukuranTamuModelToJson(this);
}


UpdatePengukuranTamuModel _$UpdatePengukuranTamuModelFromJson(
...
Map<String, dynamic> _$UpdatePengukuranTamuModelToJson(
        UpdatePengukuranTamuModel instance) =>
    <String, dynamic>{
