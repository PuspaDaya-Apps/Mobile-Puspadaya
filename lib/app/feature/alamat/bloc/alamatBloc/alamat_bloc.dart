...
class AlamatBloc extends Bloc<AlamatEvent, AlamatState> {
  ...
  Future<void> checkAlamat(
      CheckAlamatEvent event, Emitter<AlamatState> emit) async {
    ...
    if (accessToken == null) {
      ...
      try {
        List<dynamic> response =
            await GetAlamatApi().getJumlahWilayah(accessToken);

        int statusCode = response[0] as int;
        final GetJumlahWilayahResponseModel getJumlahWilayahResponseModel =
            GetJumlahWilayahResponseModel.fromJson(response[1]);
        ...
        if (statusCode == 200) {
          ...
          {
            final JumlahWilayahModel jumlahWilayahModel =
                JumlahWilayahModel.fromJson(json.decode(jumlahWilayah!));

            if (getJumlahWilayahResponseModel.totalProvinsi ==
                    jumlahWilayahModel.totalProvinsi &&
                getJumlahWilayahResponseModel.totalKabupatenKota ==
                    jumlahWilayahModel.totalKabupatenKota &&
                getJumlahWilayahResponseModel.totalKecamatan ==
                    jumlahWilayahModel.totalKecamatan &&
                getJumlahWilayahResponseModel.totalDesaKelurahan ==
                    jumlahWilayahModel.totalDesaKelurahan &&
                getJumlahWilayahResponseModel.totalDusun ==
                    jumlahWilayahModel.totalDusun) {
  ...
  Future<void> getAlamat(
      GetAlamatEvent event, Emitter<AlamatState> emit) async {
    ...
    if (accessToken == null) {
      ...
      try {
        ...
        if (statusCode == 200) {
          SharedPrefUtils().storedJumlahWilayah(json.encode(JumlahWilayahModel(
          ...
          List<dynamic> responseProvinsi = await GetAlamatApi().getProvinsi(
              accessToken, getJumlahWilayahResponseModel.totalProvinsi!);
          List<dynamic> responseKota = await GetAlamatApi().getKabupaten(
              accessToken, getJumlahWilayahResponseModel.totalKabupatenKota!);
          List<dynamic> responseKecamatan = await GetAlamatApi().getKecamatan(
              accessToken, getJumlahWilayahResponseModel.totalKecamatan!);
          List<dynamic> responseDesa = await GetAlamatApi().getDesaKelurahan(
              accessToken, getJumlahWilayahResponseModel.totalDesaKelurahan!);
          List<dynamic> responseDusun = await GetAlamatApi()
              .getDusun(accessToken, getJumlahWilayahResponseModel.totalDusun!);
          ...
          GetProvinsiResponse provinsi =
              GetProvinsiResponse.fromJson(responseProvinsi[1]);
          GetKabupatenResponse kabupatenKota =
              GetKabupatenResponse.fromJson(responseKota[1]);
          GetKecamatanResponse kecamatan =
              GetKecamatanResponse.fromJson(responseKecamatan[1]);
          GetDesaKelurahanResponse desaKelurahan =
              GetDesaKelurahanResponse.fromJson(responseDesa[1]);
          ...
          if (statusCodeProvinsi == 200 &&
            ...
            if (getCurrentUser != null) {
              CurrentUserModel currentUserModel =
                  CurrentUserModel.fromJson(json.decode(getCurrentUser));
  ...
  Future<void> mapingDataToModel(CurrentUserModel currentUserModel,
      ...
      required GetDusunResponse dusun}) async {
    try {
      ...
      for (var value in kabupatenKota.data!) {
        if (value.provinsi.id == dataWilayahModel.provinsi.id) {
          dataWilayahModel.provinsi.kabupatenKota.add(DataKabupatenKota(
              id: value.id,
      ...
      for (var valueStored in dataWilayahModel.provinsi.kabupatenKota) {
        for (var valueGet in kecamatan.data!) {
          if (valueGet.kabupatenKota.id == valueStored.id) {
            valueStored.kecamatan.add(DataKecamatan(
                id: valueGet.id,
        ...
        for (var valueStoredkecamatan in valueStoredKota.kecamatan) {
          for (var valueGet in desaKelurahan.data!) {
            if (valueGet.kecamatan.id == valueStoredkecamatan.id) {
              valueStoredkecamatan.desaKelurahan.add(DataDesaKelurahan(
                  id: valueGet.id,
            ...
            for (var valueGet in dusun.data!) {
              if (valueGet.desaKelurahan.id == valueStoredDesa.id) {
                valueStoredDesa.dusun.add(
                    DataDusun(id: valueGet.id, namaDusun: valueGet.namaDusun));
              }
            }
          }
        }
      ...
      for (var valueStoredKota in dataWilayahModel.provinsi.kabupatenKota) {
        debugPrint(
            "##kota : ${valueStoredKota.namaKabupatenKota} kecamatan : ${valueStoredKota.kecamatan.length.toString()}##");
        for (var valueStoredkecamatan in valueStoredKota.kecamatan) {
          debugPrint(
              "##kecamtan : ${valueStoredkecamatan.namaKecamatan} desa : ${valueStoredkecamatan.desaKelurahan.length.toString()}##");
          for (var valueStoredDesa in valueStoredkecamatan.desaKelurahan) {
            debugPrint(
                "##desa : ${valueStoredDesa.namaDesaKelurahan} dusun : ${valueStoredDesa.dusun.length.toString()}##");
          }
        }
      }

      SharedPrefUtils()
          .storedDataWilayah(json.encode(dataWilayahModel.toJson()));
