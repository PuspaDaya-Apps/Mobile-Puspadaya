...
import '../bloc/index_riwayat_pengukuran_anak_bloc.dart';
...
class IndexRiwayatAnakScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => IndexRiwayatPengukuranAnakBloc(),
      child: const IndexRiwayatAnakScreenView(),
    );
  }
}
...
class _IndexRiwayatAnakScreenViewState
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<IndexRiwayatPengukuranAnakBloc,
      ...
      builder: (context, state) {
        ...
        if (state is IndexRiwayatPengukuranAnakSuccess) {
