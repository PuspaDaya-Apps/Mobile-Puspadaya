...
class DetailMonitoringWasting extends StatelessWidget {
  final String id;
  DetailMonitoringWasting({super.key, required this.id});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: DetailMonitoringWastingView(
        id: id,
      ),
    );
  }
...
class DetailMonitoringWastingView extends StatefulWidget {
  final String id;
  DetailMonitoringWastingView({super.key, required this.id});
...
class _DetailMonitoringWastingViewState
  ...
  void initState() {
    context
        .read<DetailDataWastingBloc>()
        .add(FetchDetailDataWasting(id: widget.id));
    super.initState();
  }
        ...
        child: SingleChildScrollView(
          child: BlocBuilder<DetailDataWastingBloc, DetailDataWastingState>(
            builder: (context, state) {
              ...
              if (state is DetailDataWastingSuccess) {
                return Container(
                          ...
                          onValueChanged: (int? index) {
                            ...
                            context.read<SelectChartCubit>().selectChart(
                                  ...
                                  selectedWaktu == '0 bulan - 24 bulan'
                                      ? '0-24'
                                      : '2-5',
                                  state.data.data.pengukuran as List<
                                      GetDetailMonitoringAnak.Pengukuran>,
                        ...
                        onChanged: (value) {
                          ...
                          context.read<SelectChartCubit>().selectChart(
                                ...
                                state.data.data.pengukuran
                                    as List<GetDetailMonitoringAnak.Pengukuran>,
                                state.data.data.tanggalLahir,
                              );
                        },
                        onSaved: (value) {
