...
part 'riwayat_monitoring_ibu_hamil_model.g.dart';

@JsonSerializable()
class RiwayatMonitoringIbuHamilModel {
  @JsonKey(name: "message")
  final String message;
  @JsonKey(name: "data")
  final Data data;

  RiwayatMonitoringIbuHamilModel({
    required this.message,
    required this.data,
  });

  factory RiwayatMonitoringIbuHamilModel.fromJson(Map<String, dynamic> json) =>
      _$RiwayatMonitoringIbuHamilModelFromJson(json);

  Map<String, dynamic> toJson() => _$RiwayatMonitoringIbuHamilModelToJson(this);
}
